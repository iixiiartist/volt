...
pub fn inc_queries() { QUERIES_TOTAL.fetch_add(1, Ordering::Relaxed); }
pub fn inc_hits() { QUERIES_HITS.fetch_add(1, Ordering::Relaxed); }
pub fn inc_misses() { QUERIES_MISSES.fetch_add(1, Ordering::Relaxed); }
pub fn inc_tool_calls() { TOOL_CALLS_TOTAL.fetch_add(1, Ordering::Relaxed); }
pub fn inc_tool_errors() { TOOL_CALLS_ERRORS.fetch_add(1, Ordering::Relaxed); }
pub fn inc_embedding_calls() { EMBEDDING_CALLS.fetch_add(1, Ordering::Relaxed); }
pub fn set_audit_log_size(n: i64) { AUDIT_LOG_SIZE.store(n, Ordering::Relaxed); }
